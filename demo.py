...
def find_color1(frame):
    ...
    hsv_lowerbound = np.array([0, 150, 150]) #replace THIS LINE w/ your hsv lowerb
    hsv_upperbound = np.array([65, 255, 255])#replace THIS LINE w/ your hsv upperb
...
def find_color2(frame):
    ...
    """
    hsv_frame = cv2.cvtColor(frame, cv2.COLOR_BGR2HSV)
    hsv_lowerbound =  np.array([70, 95, 51])#replace THIS LINE w/ your hsv lowerb
